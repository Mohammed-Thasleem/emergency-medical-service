...
export function IncidentCard({
  ...
  return (
    <button
      ...
      className={`w-full text-left border-2 rounded-lg p-3 sm:p-4 transition-all hover:shadow-md min-h-[44px] ${
        isSelected
    ...
    >
      ...
      <p className="text-xs sm:text-sm text-gray-700 dark:text-gray-300 mb-2 sm:mb-3 line-clamp-2">
        {incident.description}
      </p>

      <div className="space-y-1.5 sm:space-y-2">
        <div className="flex items-center gap-2 text-[10px] sm:text-xs text-gray-600 dark:text-gray-400">
