    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
      ...
      <div className="space-y-3 sm:space-y-4 max-h-[500px] overflow-y-auto">
        ...
        {availableParamedics.length > 0 && (
          <div>
            <div className="flex items-center gap-2 text-xs sm:text-sm font-medium text-green-700 dark:text-green-300 mb-2">
            ...
            <div className="space-y-2">
              {availableParamedics.map((paramedic) => (
                <div
                  key={paramedic.id}
                  className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg"
                >
        ...
        {busyParamedics.length > 0 && (
          <div>
            <div className="flex items-center gap-2 text-xs sm:text-sm font-medium text-orange-700 dark:text-orange-300 mb-2">
              <UserCheck className="size-3 sm:size-4 flex-shrink-0" />
            ...
            <div className="space-y-2">
              {busyParamedics.map((paramedic) => (
                <div
                  key={paramedic.id}
                  className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-800 rounded-lg"
                >
        ...
        {offlineParamedics.length > 0 && (
          <div>
            <div className="flex items-center gap-2 text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">
              <UserX className="size-3 sm:size-4 flex-shrink-0" />
            ...
            <div className="space-y-2">
              {offlineParamedics.map((paramedic) => (
                <div
                  key={paramedic.id}
                  className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-700 rounded-lg"
                >
        ...
        {paramedics.length === 0 && (
          <div className="text-center py-8">
            <Users className="size-8 sm:size-10 text-gray-400 dark:text-gray-600 mx-auto mb-3" />
