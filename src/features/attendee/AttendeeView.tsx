...
export function AttendeeView() {
  ...
  if (showForm && !activeEmergency) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-4 sm:pt-6 pb-6">
        <div className="max-w-2xl mx-auto px-3 sm:px-4 lg:px-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sm:p-6">
            <h2 className="text-xl sm:text-2xl mb-4 sm:mb-6 text-gray-900 dark:text-white">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-4 sm:pt-6 pb-6">
      <div className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-6">
        ...
        {activeEmergency ? (
          <div className="mb-4 sm:mb-6 bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-950/30 dark:to-orange-950/30 border-l-4 border-red-500 dark:border-red-400 rounded-lg p-4 sm:p-6 shadow-lg">
            <div className="flex items-start gap-3 sm:gap-4">
              <AlertCircle className="size-5 sm:size-6 text-red-600 dark:text-red-400 flex-shrink-0 mt-1" />
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  {activeEmergency.assignedParamedicName && (
                    <div className="flex items-center gap-2 text-sm text-red-700 dark:text-red-300">
                      ...
                      <span>
                        Paramedic assigned:{" "}
                        <strong>{activeEmergency.assignedParamedicName}</strong>
                      </span>
                    </div>
                  )}
                  <div className="flex items-center gap-2 text-xs text-red-600 dark:text-red-400">
                    ...
                    <span>
                      Requested {formatTimeAgo(activeEmergency.createdAt)}
                    </span>
                  </div>
                </div>
              </div>
        ...
        {/* Emergency History */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sm:p-6">
          <h2 className="text-lg sm:text-xl mb-3 sm:mb-4 text-gray-900 dark:text-white">
        ...
        {/* Safety Information */}
        <div className="mt-4 sm:mt-6 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4 sm:p-6">
          <h3 className="text-base sm:text-lg font-medium text-blue-900 dark:text-blue-100 mb-3">
            Safety Information
          </h3>
          <ul className="space-y-2 text-xs sm:text-sm text-blue-800 dark:text-blue-200">
            ...
            <li className="flex items-start gap-2">
              ...
              <span>
                Stay at your location after requesting help so paramedics can
                find you
              </span>
            </li>
            <li className="flex items-start gap-2">
              ...
              <span>
                Medical staff will arrive as quickly as possible based on
                severity
              </span>
            </li>
          </ul>
