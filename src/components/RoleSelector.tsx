    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-3 sm:p-4">
      <div className="max-w-4xl w-full">
        <div className="text-center mb-8 sm:mb-12">
          <div className="inline-flex items-center justify-center size-12 sm:size-16 bg-blue-600 dark:bg-blue-500 rounded-full mb-3 sm:mb-4">
            <Stethoscope className="size-6 sm:size-8 text-white" />
          </div>
          <h1 className="text-2xl sm:text-3xl lg:text-4xl mb-2 text-gray-900 dark:text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
          ...
          >
            <div className="flex flex-col items-center text-center gap-3 sm:gap-4">
              <div className="size-12 sm:size-16 bg-blue-100 dark:bg-blue-950/50 rounded-full flex items-center justify-center transition-colors">
                <Users className="size-6 sm:size-8 text-blue-600 dark:text-blue-400 transition-colors" />
              </div>
              <div>
          ...
          >
            <div className="flex flex-col items-center text-center gap-3 sm:gap-4">
              <div className="size-12 sm:size-16 bg-green-100 dark:bg-green-950/50 rounded-full flex items-center justify-center transition-colors">
                <Stethoscope className="size-6 sm:size-8 text-green-600 dark:text-green-400 transition-colors" />
              </div>
              <div>
                <h3 className="text-lg sm:text-xl mb-1 sm:mb-2 text-gray-900 dark:text-white">
                  Paramedic
          ...
          >
            <div className="flex flex-col items-center text-center gap-3 sm:gap-4">
              <div className="size-12 sm:size-16 bg-purple-100 dark:bg-purple-950/50 rounded-full flex items-center justify-center transition-colors">
                <LayoutDashboard className="size-6 sm:size-8 text-purple-600 dark:text-purple-400 transition-colors" />
              </div>
              <div>
                <h3 className="text-lg sm:text-xl mb-1 sm:mb-2 text-gray-900 dark:text-white">
                  Organizer
